...
SFML_TitleScreen::SFML_TitleScreen(string texturefilename, int windowWidth, int windowHeight)
{
	//Loading Title screen Textures And Displaying The TitleScreen
	...
	//Loading Message Textures And Displaying The Message
	...
	//Setting How Often The Message Flashes On The Screen
